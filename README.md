...
```
   ...
   ```
   3º Inyectamos el servicio y usamos el signal en vez del construtor:
   ```TypeScript
...
15.  ## URL importantes
     ...
     ### Repositorios
       ...
       * #### Formularios Reactivos
          ...
          *  A. Primeros pasos: [ReactiveFormsModule](https://github.com/CinTutuDev/directiveSignals/commit/30ac250de60f583e7125c15a814ac8c59971d854)
          *  B. Otro ejemplo: [ReactiveFormsModule](https://github.com/CinTutuDev/authApp/commit/f091cdea238f1590c83217e869122f07b471b239)
